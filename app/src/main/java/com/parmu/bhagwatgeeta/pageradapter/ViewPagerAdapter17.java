...
import com.parmu.bhagwatgeeta.fragments.SeventeenFragment;
...
public class ViewPagerAdapter17 extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        if(position==0)
        {
            SeventeenFragment seventeenFragment=new SeventeenFragment();
            ...
            bundle.putString("message17", "(श्रद्धा का और शास्त्रविपरीत घोर तप करने वालों का विषय) \n" +
                    ...
                    " ॥1॥\n");
            seventeenFragment.setArguments(bundle);
            return  seventeenFragment;
        }
