...
import com.parmu.bhagwatgita.misc.RecycleViewAdapter;
import com.parmu.bhagwatgita.misc.RecycleViewItem;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String MY_PREFS_FILENAME = "com.parmu.bhagwatgita.DarkMode";
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.share_drawer:
                        ...
                        iShare.setData(Uri.parse(getResources().getString(R.string.app_link_playstore)+ "com.parmu.bhagwatgita"));
